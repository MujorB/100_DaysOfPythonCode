...
def main():
    ...
    def game_difficulty():
        ...
        if game_level == "easy": countdown = 10
        else: countdown = 5
        return countdown
    ...
    def end_game():
        ...
        while remaining_lives > 0:
            ...
            if players_guess == random_guess:
                print(f"Wow!! the actual answer was {random_guess},  You Won :)\n")
                remaining_lives = -1
            else:
                if players_guess < random_guess:                    
                    remaining_lives -= 1
    ...
    def game_checks():
        ...
        while not end_game_function:
            play_again = input("Would you love to play Number Guessing Game? Type 'y' or 'n': ")
            if play_again == 'y':
    ...
    def NUMBER_GUESSING_GAME():
        ...
        print(f"You have {countdown_scores} attempts remaining to guess the number.")
        game_checks()
